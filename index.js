...
const phoneNumber = config.pairingNumber || config.ownerNumber || "8801787638926";
...
global.botname = config.botName || "𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝";
global.themeemoji = "•";
    ...
    try {
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (config.pairingNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 234001234567 (without + or spaces) : `)));
            }
            else {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection === "open") {
                ...
                printLog('info', `[ ${config.botName || '𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝'} ]`);
...
async function main() {
    ...
    printLog('info', 'Starting 𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝 BOT...');
