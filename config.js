...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || '𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝',
    botOwner: process.env.BOT_OWNER || '𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝',
    ownerNumber: process.env.OWNER_NUMBER || '8801787638926',
    author: process.env.AUTHOR || '𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝',
    packname: process.env.PACKNAME || '𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbDJBx56buMRAYI5wW2U',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝/𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || '𝙓𝙖𝙛𝙨𝙖𝙣 𝙓 𝙏𝙖𝙘𝙝',
    // Session
